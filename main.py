...
from handlers import handlers_user, handlers_chanel, handlers_admin, handlers_autopost
from bot import bot
...
async def main() -> None:
    ...
    try:
        ...
        dp.include_router(handlers_user.router)  # Пользовательские обработчики
        dp.include_router(handlers_chanel.router)  # Административные обработчики
        dp.include_router(handlers_admin.router)  # Административные обработчики
        dp.include_router(handlers_autopost.router)  # Административные обработчики
